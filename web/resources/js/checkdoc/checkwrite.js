...
$(function(){
    ...
    $("#btn_2").click(function(){
        ...
        '<label id ="tdplus" class="buttonla labu" > + </label> &nbsp; <label id="tdminus" class="buttonla labu"> - </label>'+
        '&nbsp;&nbsp;&nbsp;&nbsp;<label id="checkpay" class="buttonla">최종 금액 출력</label>'+
        '<div id="paid">'+
         '최종금액 :<label id= "endpay"></label>'+'<input type="text" name="endpay" id="paide">'+
        '<table>'+
           ' <thead><tr><td>번호</td><td>물품명</td><td>단가</td><td>수량</td><td>단위</td><td>금액</td><td>비고</td></tr></thead>'+
            ...
            '</tbody>'+
        '</table>'+
        '<textarea cols="90" rows="7" id= "txta"></textarea>'+
    '</div>'
   )
  ...
  $("#checkpay").on("click",function (){
      ...
      var b = 0;
      //console.log(a.eq(0).find(".pay").val())
    ...
    $("#btn_3").click(function(){
   	 ...
   	 $("#docbody").html(
   		...
   		'<textarea name="text" id="txtav" cols= "85" rows="20" >'+
