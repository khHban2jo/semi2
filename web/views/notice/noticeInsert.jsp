            ...
            <div id="notice" align="center;">
            	<table class="managerTable">
		          <form action="<%= request.getContextPath()%>/noticeServletInsert" method="POST">
		              <tr>
		                  <thead><th>공지 사항 작성</th></thead>
		              </tr>
		              <tr>
		              	<td style="font-size: 18px;">제목 작성 : <input type="text" name="title" style="width: 800px; height: 30px"> </td>
		              </tr>
		              <tr>
		              	<td style="font-size: 18px;">작성자 ID : <input type="hidden" name="nwriter" value="admin"> <%--<%= m %>--%>admin </td><!-- 로그인 시에 구현 해야 된다. -->
		              </tr>
		              <tr>
<!-- 자바스크립트의 변수를 JSP에 넘겨주지는 못합니다. 방법은 있지만 코드가 길어지고 복잡해 진다.-->
						<td style="font-size: 18px;">작성일  : <input type="hidden" id="nowDate" name="nowDate" value=""><label id = "now"></label> </td>
		              </tr>
		              <tr>
		              	...
		              	폰트 크기 선택<select id="font_size">
		              		...
		              		<textarea id="ncontent" name="ncontent" style=" height:580px; width:880px; resize:none; font-size: 20px"></textarea>
		              	</td>
		              </tr>
		              <tfoot>
		              <tr align="center">
    ...
    (function () { 
    	var day = new Date();
    	var nday = document.getElementById("nowDate").value = day.getFullYear()+"-"
