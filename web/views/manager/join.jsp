...
<head>
 ...
 <form action="<%=request.getContextPath() %>/mInsert.me" method="POST" onsubmit="return check()">
				...
				<h2 class="managerTable">사원 정보 입력</h2>
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" id="uid" name="userId" maxlength="20" readonly placeholder="영어이름 먼저입력">
