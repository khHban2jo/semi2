...
<!--   <link rel="stylesheet" href="/semi/resources/css/manager/manageView.css"> -->
 ...
 <form action="<%=request.getContextPath() %>/mInsert.me" method="POST" onsubmit="return check()" >
			...
			<tbody>
				<tr>
					<td id="hleft" style="width:5;"><h5><span style="color:red;">* </span> 사 번</h5></td>
					<td><input type="text" id="mEmpCode" name="empCode" readonly>&nbsp;
						<input type="button" value="확인" id="checkemp" > 
					<td rowspan="5" id="pic" style="width:200px; border:1px solid black;" ><img src=""  id="Show" alt="프로필사진"></td>
				</tr>
				
				<tr>
					<td id="hleft"><h5><span style="color:red;">* </span> 이 름</h5></td>
					<td><input type="text" id="pName" name="empName" maxlength="8">&nbsp;&nbsp;
					
				</tr>
				<tr>
					<td id="hleft"><h5><span style="color:red;">* </span> 영문이름</h5></td>
					<td><input type="text" id="eName1" maxlength="8" placeholder="성" name="eName">&nbsp;&nbsp;
		              	  <input type="text" id="eName2" maxlength="8" placeholder="이름">
		              	  <input type="button" id="eNameCheck" value="입력"></td>
				</tr>
				...
				<tr>
					<td id="hleft">아이디</td>
					<td><input type="text" id="uid" name="userId" maxlength="20"
						readonly placeholder="영어이름 먼저입력"> <input type="button"
						id="checkId" value="중복확인" disabled></td>
				</tr>
				<tr>
					<td id="hleft">비밀번호</td>
				...
				<tr>
					<td id="hleft">비밀번호 확인</td>
					<td><input type="password" id="pwd2" maxlength="16">&nbsp;
						<input type="button" id="pwdCheck" value="확 인"></td>
				</tr>
				<tr>
					<td id="hleft"><h5><span style="color:red;">* </span> 주민등록번호</h5></td>
					<td><input type="text" id="psid" maxlength="13"
						placeholder="-없이 입력" name="personalId">&nbsp; <input
						type="button" id="pschk" value="확인">
					<td></td>
				</tr>
				<tr>
					<td id="hleft">이메일</td>
					<td><input type="text" id="mail" name="email"> <select
						id="maillist">
							<option value="">직접 입력</option>
							<option value="@daum.net">@daum.net</option>
							<option value="@naver.com">@naver.com</option>
				...
				<tr>
					<td id="hleft">성 별</td>
					<td><input type="radio" value="M" name="gender" id="male"
						readonly> 남 &nbsp; <input type="radio" value="F"
						id="female" name="gender" readonly> 여</td>
						<td></td>
				</tr>
				<tr>
					<td id="hleft">나이</td>
				...
				<tr>
					<td id="hleft">연락처(자택)</td>
					<td colspan="2"><input type="text" list="t1" name="tel1"
						id="tt1" style="width:100px;"> <datalist id="t1" style="width:100px;">
							<option value="02">서울</option>
							<option value="031">경기</option>
							<option value="032">인천</option>
							<option value="033">강원</option>
				...
				<tr>
					<td id="hleft"><h5><span style="color:red;">* </span> 연락처(PHONE)</h5></td>
				...
				<tr>
					...
					<td><select name="cr" id="crv">
							...
							<option value="1">정</option>
							<option value="2">부</option>
					</select> <select name="cr2" style="width: 150px;" id="crv2" disabled>
							<option value="">--</option>
							<option value="D0">임원</option>
							<option value="D1">인사부서</option>
							<option value="D2">영업부서</option>
				...
				<tr>
					...
					<td><input type="file" id="" value="사진 전송"
						onchange="ShowImage(this);"></td>
						<td></td>
				</tr>
				<tr>
					<td id="hleft">비고</td>
					<td colspan="2" rowspan="2"><textarea
							style="resize: none; width: 600px; height: 60px;" name="etc">
			...
			<tfoot>
				<tr>
					<td align="center" colspan="3" style="border:0px;"><input type="submit"
						...
						style="width: 100px; height: 30px; text-align: center;"></td>
				</tr>
			</tfoot>
